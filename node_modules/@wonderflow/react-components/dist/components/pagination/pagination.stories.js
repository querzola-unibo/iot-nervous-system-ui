...
export const Default = ({ itemsPerPage, ...args }) => {
    const items = useMemo(() => [
        {
            ip: '212.5.90.2',
            os: 'MacOS Sierra',
    ...
    return (_jsxs(_Fragment, { children: [currentItems?.map((item) => (_jsx("h3", { children: item.ip }, item.ip))), _jsx(Pagination, { ...args, itemsCount: items.length, onPageClick: data => handlePageClick(data) })] }));
};
